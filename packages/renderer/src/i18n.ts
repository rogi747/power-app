    ...
    resources: {
      en: {
        translation: {
          ...
          // RPA — navigation & sub-pages
          rpa_builder: 'Process Builder',
          rpa_logs: 'Run Logs',
          rpa_scheduler: 'Scheduler',

          // RPA — workflow list
          rpa_new_workflow: 'New workflow',
          rpa_search_placeholder: 'Search workflows',
          rpa_import: 'Import',
          rpa_export: 'Export',
          rpa_edit: 'Edit',
          rpa_duplicate: 'Duplicate',
          rpa_delete: 'Delete',
          rpa_run: 'Run',
          rpa_untitled: 'Untitled workflow',
          rpa_column_name: 'Name',
          rpa_column_description: 'Description',
          rpa_column_tags: 'Tags',
          rpa_column_updated: 'Updated',
          rpa_delete_confirm: 'Delete workflow "{{name}}"? This cannot be undone.',
          rpa_duplicated: 'Workflow duplicated',
          rpa_deleted: 'Workflow deleted',
          rpa_exported: 'Workflow exported',
          rpa_export_failed: 'Export failed',
          rpa_imported: 'Workflow imported',
          rpa_import_failed: 'Import failed — invalid workflow file',
          rpa_run_title: 'Run "{{name}}"',
          rpa_run_select_profiles: 'Select the profiles to run this workflow on.',
          rpa_run_profiles_placeholder: 'Select profiles',
          rpa_run_started: 'Run started',
          rpa_run_failed: 'Failed to start run',
          rpa_run_cancel: 'Cancel run',
          rpa_run_cancelled: 'Run cancelled',

          // RPA — builder
          rpa_back: 'Back',
          rpa_workflow_name: 'Workflow name',
          rpa_save: 'Save',
          rpa_saved: 'Workflow saved',
          rpa_save_failed: 'Save failed',
          rpa_settings: 'Settings',
          rpa_description: 'Description',
          rpa_variables: 'Variables',
          rpa_add_variable: 'Add variable',
          rpa_var_name: 'Name',
          rpa_var_scope: 'Scope',
          rpa_var_value: 'Value',
          rpa_default_timeout: 'Default timeout (ms)',
          rpa_default_retry: 'Default retry count',
          rpa_continue_on_error: 'Continue on error',
          rpa_unsaved: 'Unsaved',
          rpa_all_saved: 'Saved',
          rpa_unsaved_title: 'Unsaved changes',
          rpa_unsaved_body: 'You have unsaved changes. Save before leaving?',
          rpa_save_and_leave: 'Save and leave',
          rpa_leave_without_saving: 'Leave without saving',

          // RPA — run logs
          rpa_log_time: 'Time',
          rpa_log_workflow: 'Workflow',
          rpa_log_node: 'Node',
          rpa_log_profile: 'Profile',
          rpa_log_status: 'Status',
          rpa_log_duration: 'Duration',
          rpa_log_message: 'Message',
          rpa_log_run_summary: 'Run summary',
          rpa_log_filter_status: 'Filter by status',
          rpa_logs_pause: 'Pause',
          rpa_logs_resume: 'Resume',
          rpa_logs_live_on: 'Live updates on',
          rpa_logs_live_off: 'Live updates paused',
          rpa_logs_export: 'Export logs',
          rpa_logs_exported: 'Logs exported',
          rpa_logs_clear: 'Clear logs',
          rpa_logs_cleared: 'Logs cleared',
          rpa_status_waiting: 'Waiting',
          rpa_status_queued: 'Queued',
          rpa_status_running: 'Running',
          rpa_status_paused: 'Paused',
          rpa_status_completed: 'Completed',
          rpa_status_cancelled: 'Cancelled',
          rpa_status_error: 'Error',
          rpa_status_retry: 'Retry',

          // RPA — scheduler
          rpa_schedule_new: 'New schedule',
          rpa_schedule_name: 'Name',
          rpa_schedule_name_placeholder: 'e.g. Nightly data sync',
          rpa_schedule_name_required: 'Please enter a name',
          rpa_schedule_workflow: 'Workflow',
          rpa_schedule_workflow_placeholder: 'Select a workflow',
          rpa_schedule_workflow_required: 'Please select a workflow',
          rpa_schedule_cron: 'Schedule (cron)',
          rpa_schedule_cron_required: 'Please enter a cron expression',
          rpa_schedule_profiles: 'Profiles',
          rpa_schedule_profiles_required: 'Please select at least one profile',
          rpa_schedule_profile_count: '{{count}} profile(s)',
          rpa_schedule_next_run: 'Next run',
          rpa_schedule_enabled: 'Enabled',
          rpa_schedule_empty: 'No schedules yet. Create one to run workflows automatically.',
          rpa_schedule_created: 'Schedule created',
          rpa_schedule_create_failed: 'Failed to create schedule',
          rpa_schedule_deleted: 'Schedule deleted',
          rpa_schedule_delete_confirm: 'Delete schedule "{{name}}"?',
          rpa_cron_every_15m: 'Every 15 min',
          rpa_cron_hourly: 'Hourly',
          rpa_cron_daily_9: 'Daily 09:00',
          rpa_cron_weekly_mon: 'Mon 09:00',
      ...
      zh: {
        translation: {
          ...
          // RPA — 工作流列表
          rpa_new_workflow: '新建工作流',
          rpa_search_placeholder: '搜索工作流',
          rpa_import: '导入',
          rpa_export: '导出',
          rpa_edit: '编辑',
          rpa_duplicate: '复制',
          ...
          rpa_untitled: '未命名工作流',
          rpa_column_name: '名称',
          rpa_column_description: '描述',
          rpa_column_tags: '标签',
          rpa_column_updated: '更新时间',
          rpa_delete_confirm: '确定删除工作流“{{name}}”吗？此操作不可恢复。',
          rpa_duplicated: '工作流已复制',
          rpa_deleted: '工作流已删除',
          rpa_exported: '工作流已导出',
          rpa_export_failed: '导出失败',
          rpa_imported: '工作流已导入',
          rpa_import_failed: '导入失败 — 工作流文件无效',
          rpa_run_title: '运行“{{name}}”',
          rpa_run_select_profiles: '请选择要运行此工作流的窗口。',
          rpa_run_profiles_placeholder: '选择窗口',
          rpa_run_started: '已开始运行',
          rpa_run_failed: '启动运行失败',
          rpa_run_cancel: '取消运行',
          rpa_run_cancelled: '运行已取消',

          // RPA — 编辑器
          rpa_back: '返回',
          rpa_workflow_name: '工作流名称',
          rpa_save: '保存',
          rpa_saved: '工作流已保存',
          rpa_save_failed: '保存失败',
          rpa_settings: '设置',
          rpa_description: '描述',
          rpa_variables: '变量',
          rpa_add_variable: '添加变量',
          rpa_var_name: '名称',
          rpa_var_scope: '作用域',
          rpa_var_value: '值',
          rpa_default_timeout: '默认超时 (ms)',
          rpa_default_retry: '默认重试次数',
          rpa_continue_on_error: '出错时继续',
          rpa_unsaved: '未保存',
          rpa_all_saved: '已保存',
          rpa_unsaved_title: '有未保存的更改',
          rpa_unsaved_body: '您有未保存的更改，离开前是否保存？',
          rpa_save_and_leave: '保存并离开',
          rpa_leave_without_saving: '不保存离开',

          // RPA — 运行日志
          rpa_log_time: '时间',
          rpa_log_workflow: '工作流',
          rpa_log_node: '节点',
          rpa_log_profile: '窗口',
          rpa_log_status: '状态',
          rpa_log_duration: '耗时',
          rpa_log_message: '消息',
          rpa_log_run_summary: '运行汇总',
          rpa_log_filter_status: '按状态筛选',
          rpa_logs_pause: '暂停',
          rpa_logs_resume: '继续',
          rpa_logs_live_on: '实时更新已开启',
          rpa_logs_live_off: '实时更新已暂停',
          rpa_logs_export: '导出日志',
          rpa_logs_exported: '日志已导出',
          rpa_logs_clear: '清空日志',
          rpa_logs_cleared: '日志已清空',
          rpa_status_waiting: '等待中',
          rpa_status_queued: '排队中',
          rpa_status_running: '运行中',
          rpa_status_paused: '已暂停',
          rpa_status_completed: '已完成',
          rpa_status_cancelled: '已取消',
          rpa_status_error: '错误',
          rpa_status_retry: '重试',

          // RPA — 定时任务
          rpa_schedule_new: '新建定时任务',
          rpa_schedule_name: '名称',
          rpa_schedule_name_placeholder: '例如：每晚数据同步',
          rpa_schedule_name_required: '请输入名称',
          rpa_schedule_workflow: '工作流',
          rpa_schedule_workflow_placeholder: '选择工作流',
          rpa_schedule_workflow_required: '请选择工作流',
          rpa_schedule_cron: '定时 (cron)',
          rpa_schedule_cron_required: '请输入 cron 表达式',
          rpa_schedule_profiles: '窗口',
          rpa_schedule_profiles_required: '请至少选择一个窗口',
          rpa_schedule_profile_count: '{{count}} 个窗口',
          rpa_schedule_next_run: '下次运行',
          rpa_schedule_enabled: '启用',
          rpa_schedule_empty: '暂无定时任务。创建一个以自动运行工作流。',
          rpa_schedule_created: '定时任务已创建',
          rpa_schedule_create_failed: '创建定时任务失败',
          rpa_schedule_deleted: '定时任务已删除',
          rpa_schedule_delete_confirm: '确定删除定时任务“{{name}}”吗？',
          rpa_cron_every_15m: '每 15 分钟',
          rpa_cron_hourly: '每小时',
          rpa_cron_daily_9: '每天 09:00',
          rpa_cron_weekly_mon: '周一 09:00',
